...
var
  WideCaptionHolders: TComponentList = nil;
...
begin
  InitAtomStrings;
  WindowAtom := WinCheckH(GlobalFindAtom(PAnsiChar(WindowAtomString)));
  ControlAtom := WinCheckH(GlobalFindAtom(PAnsiChar(ControlAtomString)));
end;

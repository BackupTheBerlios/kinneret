...
type
  TAnsiStringsForWideStrings = class(TAnsiStrings{TNT-ALLOW TAnsiStrings})
  private
...
procedure TAnsiStringsForWideStrings.SaveToStreamEx(Stream: TStream; CodePage: Cardinal);
var
  S: AnsiString;
begin

...
void PrintHelp()
{
	...
	"--method=[type] (-m):			Method, valid types are:"						"\n"
	"					adsl, cable, dialup and lan"								"\n"
	...
	"--myarea=[area-code]			The area code you are in: 02, 03, 04 etc."		"\n"
	"--phonenumber=[number]			The server's phone number, you can get a list"	"\n"
	"					of the numbers of you ISP using --ispinfo"					"\n"
	"\n"
	"Information:"																	"\n"
    ...
    "--currentshow				Shows current connection"							"\n"
    "\n"
	"Managment:"																	"\n"
	"--delete [name]				Deletes a connection"							"\n"
	"--default=[name]			Sets default connection"							"\n"
    "--clearcurr				Clears current connection"							"\n"
